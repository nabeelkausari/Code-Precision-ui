...
class ResultsFlyout extends Component {
    render() {
        const {secondary} = this.props
        return (
                <Flyout require_pin = {true} require_download = {true} require_full_screen ={true} sequence_no = {1} title={"HELO WASSUP"} secondary = {secondary}>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consectetur cum cumque cupiditate
                        debitis error excepturi ipsa iste iure iusto laudantium nostrum,
                        odit sequi sit. Exercitationem obcaecati rem repellendus similique temporibus?</p>
                </Flyout>
        );
    }
}

export default resultsContainer(ResultsFlyout);
