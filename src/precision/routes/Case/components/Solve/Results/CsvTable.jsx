...
//   border-left: 1px solid ${allColors.light_grey};
//   border-right: 1px solid ${allColors.light_grey};
//   border-bottom: 1px solid ${allColors.light_grey};
//   font-size: 12px;
//   white-space: nowrap;
// `;
...
//   border-bottom: 1px solid ${allColors.light_grey};
//   border-right: 1px solid ${allColors.light_grey};
//   border-top: 1px solid ${allColors.light_grey};
// `;
