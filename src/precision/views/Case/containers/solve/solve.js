...
const mapStateToProps = (state, props) =>{
    ...
    const {cases :
                {info, flyout : {primary, secondary} , steps, case_loading, steps_loading,  fetch_case_succeeded, fetch_steps_succeeded,
                     }, functions:{function_categories_loading, functions_loading}
            } = state;
